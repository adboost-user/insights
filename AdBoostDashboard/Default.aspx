<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AdBoostDashboard.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-blue pull-right">Campaña
                        <a class="collapse-link">
                            <i class="fa fa-chevron-blue-up"></i>
                        </a>
                    </span>
                    <h5>Clics</h5>
                </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-green pull-right">Campaña
                        <a class="collapse-link">
                            <i class="fa fa-chevron-green-up"></i>
                        </a>
                    </span>
                    <h5>CTR</h5>
                </div>
    ...
    <div class="row" id="GraficoInfo" runat="server">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>
                        <asp:Literal ID="LitTitulo" runat="server"></asp:Literal></h5>
                    <div class="pull-left">
                        <div class="btn-group">
                    ...
                    <div class="ibox-tools">
                        ...
                        <form runat="server">
                            ...
                            <label>
                                Mostrar<%--<input class="form-control pull-right" type="text" name="daterange" value="01/01/2015 - 01/31/2015">--%>
                            </label>
                            <asp:DropDownList ID="GraficoLista" runat="server" AutoPostBack="True"
                                ...
                                <asp:ListItem Text="Personalizado" Value="1"></asp:ListItem>
                ...
                <div class="ibox-content">
                    <div class="row">
                        <table id="LabelTit"></table>
                    </div>
                    <div class="row">
                        <div class="col-lg-9">
                            <h4>
                                <asp:Literal ID="LitGrafInfo" runat="server"></asp:Literal></h4>
                        ...
                        <div class="col-lg-3">
                            <ul class="stat-list">
                                <li>
                                    <h2 class="no-margins">
                                        <asp:Literal ID="LitImpGrafico" runat="server"></asp:Literal></h2>
                                ...
                                <li>
                                    <h2 class="no-margins ">
                                        <asp:Literal ID="LitClicsGrafico" runat="server"></asp:Literal></h2>
                                    <small>Clics</small>
                                ...
                                <li>
                                    <h2 class="no-margins ">
                                        <asp:Literal ID="LitCTRgrafico" runat="server"></asp:Literal></h2>
                                    <small>CTR</small>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" id="jsonTable" aria-describedby="DataTables_Table_0_info" role="grid">
                            </table>
    ...
    <%--<div runat="server" id="DataDiv2" style="display: none;"></div>--%>
    <%--<div runat="server" id="DataDiv3" style="display: none;"></div>--%>
    ...
    <script>
        $(document).ready(function () {
            ...
            var options = {
                ...
                yaxes: [{
                    position: "left",
                    //max: 50000, comentario para que sea automatico el tamaño no predefinido
                    color: "#d5d5d5",
                    axisLabelUseCanvas: true,
                    axisLabelFontSizePixels: 12,
                    axisLabelFontFamily: 'Arial',
